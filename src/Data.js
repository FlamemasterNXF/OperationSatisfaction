function getDefaultObject() {
    return {
        numbers: [new Decimal(1),new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),new Decimal(0),],
        //misc
        time: Date.now(),
        currentTab: 1,
    }
...
//saving and loading
function save(){
    window.localStorage.setItem('opSatisfactionSave', JSON.stringify(data))
}
function load() {
    let savedata = JSON.parse(window.localStorage.getItem('opSatisfactionSave'))
